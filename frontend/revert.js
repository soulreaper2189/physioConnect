...
const files = [
  ...
  'c:/Users/likhi/Desktop/healthcare/frontend/src/pages/PatientDashboard.jsx'
];
...
const repls = {
    ...
    'border-brand-accent/50': 'border-indigo-400',
    'border-brand-accent/60': 'border-indigo-400',
    'hover:border-brand-accent/30': 'hover:border-indigo-300',
    'hover:border-brand-accent/50': 'hover:border-indigo-300',
    'hover:border-brand-accent/60': 'hover:border-indigo-300',
    ...
    'bg-yellow-900/30': 'bg-yellow-100',
    'text-yellow-400': 'text-yellow-700',
    'border-yellow-800': 'border-yellow-200',
    'bg-green-900/30': 'bg-green-100',
    'text-green-400': 'text-green-700',
    'border-green-800': 'border-green-200',
    'bg-red-900/40': 'bg-red-50',
    'text-red-300': 'text-red-700',
    'bg-yellow-900/40': 'bg-yellow-50',
    'text-yellow-300': 'text-yellow-700',
    'bg-green-900/40': 'bg-green-50',
    'text-green-300': 'text-green-700',
    "['#6D28D9', '#3D355C']": "['#4F46E5', '#F1F5F9']",
    "stroke='#3D355C'": "stroke='#E2E8F0'",
    "fill: '#A78BFA'": "fill: '#64748B'",
    "backgroundColor: '#2A2342'": "backgroundColor: '#FFFFFF'",
    "border: '1px solid #3D355C'": "border: 'none'",
    "color: '#F3F4F6'": "color: '#0F172A'",
    "stroke='#6D28D9'": "stroke='#4F46E5'",
    "fill: '#6D28D9'": "fill: '#4F46E5'",
    "stroke: '#F3F4F6'": "stroke: '#FFFFFF'"
};
